        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p
              ...
              style={{ fontSize: "14px" }}
            >
              Please note that the registry is a guide to our preferred items
              and brands, not linked to any specific store. Colours are
              flexible, though we recommend neutral tones. You’re free to
              purchase from any store of your choice.
            </p>
